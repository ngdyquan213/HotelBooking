            ...
            <form id="add_room_form" autocomplete="off">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Add Room</h>
                    </div>
    ...
    <div class="modal fade" id="edit-room" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <form id="edit_room_form" autocomplete="off">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Edit Room</h>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                ...
                <div class="modal-body">
                    ...
                    <div class="border-bottom border-3 pb-3 mb-3">
                        <form id="add_image_form">
                            ...
                            <input type="file" name="image" accept=".png, .webp, .jpeg, .jpg" class="form-control shadow-none mb-3" required>
        ...
        function add_room() {
            ...
            xhr.onload = function() {
                ...
                if (this.responseText == 1) {
                    ...
                    alert('error', 'Add failed. Server Down!');
                }
            }
            xhr.send(data);
        }
        ...
        function toggle_status(id, val) {
            ...
            xhr.onload = function() {
                if (this.responseText == 1) {
                    ...
                    alert('success', 'Status toggled!. Server Down!');
                    get_all_rooms();
                }
            }
        ...
        function add_image() {
            ...
            xhr.onload = function() {
                ...
                if (this.responseText == 'inv_img') {
                    ...
                    alert('success', 'New Image member!','image-alert');
                    room_images(add_image_form.elements['room_id'].value, document.querySelector('#room-images .modal-title').innerHTML)
