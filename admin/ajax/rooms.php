<?php
    ...
    if(isset($_POST['add_room'])){
        ...
        if($stmt = mysqli_prepare($con,$q3)){
            ...
            $flag = 0;
            die('Query cannot be prepared - Insert Feature');
        }
    ...
    if(isset($_POST['edit_room'])){
        ...
        $del_features = detele("DELETE FROM `room_features` WHERE `room_id` =?",[$frm_data['room_id']],'i');
        $del_facilities = detele("DELETE FROM `room_facilities` WHERE `room_id` =?",[$frm_data['room_id']],'i');
    ...
    if(isset($_POST['remove_room'])){
        ...
        $res2 = detele("DELETE FROM `room_images` WHERE `room_id`=?",[$frm_data['room_id']],'i');
        $res3 = detele("DELETE FROM `room_features` WHERE `room_id`=?",[$frm_data['room_id']],'i');
        $res4 = detele("DELETE FROM `room_facilities` WHERE `room_id`=?",[$frm_data['room_id']],'i');
