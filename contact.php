...
<body class="bg-light">
                ...
                <div class="bg-white rounded shadow p-4">
                    <form method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="message" required class="form-control shadow-none" rows="5" stype="resize: none;"></textarea>
                        </div>
    ...
    <?php
        if(isset($_POST['send'])){
            ...
            if($res == 1){
                alter('success', 'Mail Sent Success');
            }else{
                alter('error', 'Server Down! Try Again Later.');
            }
        }
    ?>
