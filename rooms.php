...
<body class="bg-light">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-12 mb-lg-0 mb-4 ps-0">
                    ...
                    <div class="container-fluid flex-lg-column align-items-stretch">
                        ...
                        <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="filterDropdown">
                            <div class="border bg-light p-3 rounded mb-3">
                                <h5 class="mb-3" stype="form-size: 18px;">CHECK AVAILABILITY</h5>
                            ...
                            <div class="border bg-light p-3 rounded mb-3">
                                <h5 class="mb-3" stype="form-size: 18px;">FACILITIES</h5>
                                <div class="mb-2">
                            ...
                            <div class="border bg-light p-3 rounded mb-3">
                                <h5 class="mb-3" stype="form-size: 18px;">GUESTS</h5>
                                <div class="d-flex">
                                    <div class="me-3">
