<nav id="nav-bar" class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
    <div class="container-fluid">
        <a class="navbar-brand me-5 fw-bold fs-3 h-font" href="index.php">DQ Hotel</a>
            ...
            <form id="register-form">
                ...
                <div class="modal-body">
                    <span class="badge rounded-pill bg-light text-dark mb-3 text-wrap lh-base">
                        Note: Your details must match with your ID (Aadhaar card, password, driving license, etc.) that will be required during check-in.
                    </span>
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-md-6 p-0 mb-3">
                                ...
                                <input name="cpass" type="password" class="password form-control shadow-none" required>
                            </div>
                        </div>
                    </div>
